...
export const VitesseThemes = {
  ...
  border: ['#303030', '#f0f0f0'],
  background: ['#1d1f21', '#ffffff'],
  activeBackground: ['#343434', '#f5f5f5'],

  comment: ['#758575', '#a0ada0'],
  string: ['#c98a7d', '#b56959'],
  literal: ['#429988', '#2f8a89'],
  variable: ['#b8a965', '#8c862b'],
  keyword: ['#4d9375', '#1c6b48'],
  number: ['#6394bf', '#296aa3'],
  boolean: ['#4d9375', '#1c6b48'],
  function: ['#a1b567', '#6c7834'],
  constant: ['#d4976c', '#a65e2b'],
  class: ['#5eaab5', '#2993a3'],
  interface: ['#67b893', '#2e8f63'],
  builtin: ['#cb7676', '#ab5959'],
  property: ['#e0a569', '#b58451'],
  namespace: ['#db889a', '#b05a78'],
  punctuation: ['#858585', '#8e8f8b'],
